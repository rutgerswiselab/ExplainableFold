...
from explainable_fold.models.exp_models_sub import SubModel
...
def sub_main(args):
    if args.seed is not None:  # set random seed
        set_seed(args.seed)
    output_dir = os.path.join(args.output_dir, args.opt_type + "_sub")
    ...
    model.bfloat16()  # JT: test if bfloat16 works
    # model.train()
